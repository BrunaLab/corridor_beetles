---
title             : "Effect of experimental habitat connectivity on dung beetle communities"
shorttitle        : "dung beetles and habitat corridors"

author: 
  - name          : "Eric Escobar-Chena"
    affiliation   : "1"
...
authornote: |
  <!-- EEC: Department of Wildlife Ecology & Conservation, University of Florida, PO Box 110530, Gainesville, Florida, 32611-0430 USA -->
  <!-- JR: University of Colorado, Boulder -->
...
# r_refs("
# here("corridor_docs","eric_ms_thesis","eric-thesis.bib")
# ")
...
By measuring changes in biodiversity and species richness within experimental designs we were able to isolate factors might be contributing to ecological patterns and processes [@fletcher_jr_landscape_2023; @resasco_contribution_2017]. Past studies have endeavored to experimentally measure changes in community compositions as a result of connecting habitats with corridors [@collins_fragmentation_2017; @graham_impact_2022; @tewksbury_corridors_2002]  Yet very few have directly compared matrix and patch populations. Land use is different from one species to another so it is vital to understand where compositions are distributed and what processes might be driving population differences[@haddad_corridor_1999]. 
...
Species-specific differences are apparent but do not follow any particular trend. _Aphodius alloblackburneus_ had a disproportionate positive effect to being captured in matrix patches as compared to other species. Beetles from the genus _Aphodius_ do tend to show patterns of habitat specificity [@roslin_distribution_2001], and many preferring forested habitat [@frank_land_2017],  so it is not unexpected that they might show a preference towards forested matrix. We did not detect that any species was more positively associated with open patches despite suggestions that some species (e.g., _Canthon vigilans_, _Melanocanthon bispinatus_) prefered open habitat [@conover_phenology_2019; @nealis_habitat_1977]. This could be another sign pointing towards matrix acting as a source population, and since open habitat was much less dominant in our experimental system beetles could be moving into patches from habitat edge. 
...
```{r spcodes, echo=FALSE, message = FALSE, warning=FALSE}
...
```{r label="patches", echo=FALSE, fig.align='center', fig.cap="Experiemental patches at the SRS", message=FALSE, warning=FALSE, out.width="100%"}

# knitr::include_graphics("images/patches-pic.png")

imgA <- magick::image_read("./images/patches-pic.png")
imgB <- magick::image_read("./images/pitfalls.png")
magick::image_append(c(imgA, imgB))
...
```{r, label = patch, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = paste("Mean abundance in each SRS patch type of (A) all dung beetle species combined and (B) each of the six most abundant dung beetle species. Species codes: ", species_names,".", sep=""), out.width="90%", fig.align='center'} 

# knitr::include_graphics("images/total_abund.png")


imgA <- magick::image_read("./images/total_abund.png")
imgB <- magick::image_read("./images/sp_abund_patch.png")
magick::image_append(c(imgA, imgB))
...
<!-- ```{r, label = abundance, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = paste("Average abundance of the six most abundant dung beetle species captured at the SRS site by species by patch type. Species codes: ", species_names,".",sep=""), out.width="70%", fig.align='center'} -->
...
```{r, label = sp-bmass, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Total biomass of the ten most common dung beetle species captured at the SRS.", out.width="100%", fig.align='center'}
...
```{r, label = patch-bmass, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Average total biomass of beetles by (A) patch type and (B) block.", out.width="100%", fig.align='center'}


# knitr::include_graphics("images/avg_bmass_patch_plot.png")

imgA <- magick::image_read("./images/avg_bmass_patch_plot.png")
imgB <- magick::image_read("./images/avg_bmass_block_plot.png")
magick::image_append(c(imgA, imgB))
```
...
```{r, label = richness, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "(A) Species richness, (B) Shannon Diversity, and (C) Simpson's Diversity of dung beetle species in each of the SRS patch types. The shape of the points indicates the block in which a patch was located.", out.width="100%", fig.align='center'}

# knitr::include_graphics("images/sp_richness_patches.png")


imgA <- magick::image_read("./images/sp_richness_patches.png")
imgB <- magick::image_read("./images/sp_shannon_patches.png")
imgC <- magick::image_read("./images/sp_simpson_patches.png")
magick::image_append(c(imgA, imgB,imgC))
```
...
<!-- \newpage    -->
<!-- ```{r, label = combined, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Dung beetle Simpson's index by patch type.", out.width="40%", fig.align='center'} -->
...
<!-- img1 <- readPNG("images/sp_richness_patches.png") -->
<!-- img2 <- readPNG("images/sp_simpson_patches.png") -->
<!-- img3 <- readPNG("images/sp_shannon_patches.png") -->
<!-- img12 <- abind::abind(img1,img2,img3,along=1) -->
<!-- png::writePNG(img12,"images/combined.png") -->
