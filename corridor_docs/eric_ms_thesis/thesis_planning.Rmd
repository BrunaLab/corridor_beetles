...
Overall, 5,213 total dung beetles were collected belonging to 16 species. The most common species were C. vigilans (n=1473), Ateuchus lecontei (n=1115), and Phanaeus igneus (n=958). All but one species was found in matrix plots at fifteen species, with the exception of Geotrupes blackburnii, one of our only singletons along with Onthophagous turberculifrons. The winged patch had the next most species at fourteen, rectangular followed with thirteen, and connected patches had the fewest species at twelve (Table 1). Beetle abundance was significantly higher in matrix plots with 33% (n = 1713) of captures followed by 26% (n = 1359) caught in connected patches, 23% (n = 1199) in winged, and lastly 18% (n = 942) from rectanglar patches (Table 2). 
...
Assemblage composition was mostly uniform across patch types, however 
