...
Compared to the other treatment types the greatest number of individual beetles were captured from matrix habitat. Likewise, for each of the most dominant species the highest counts came from the matrix. 
