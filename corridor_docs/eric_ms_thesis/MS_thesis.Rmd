...
I used linear mixed-effects models to compare the influence of patch type on both Shannon Diversity and Simpson's indexes, including block as a random effect to account for spatial variation. Across both diversity models, the block-level random effect standard deviation was slightly greater than the residual error, indicating that variation between blocks accounted for a substantial portion of the overall variability. Likewise, linear mixed-effects models were used to compare the average biomass of individual dung beetles in each patch type, once again including block as a random effect. 



**[need to add to the last paragraph:** that you did these analyses for the dung beetle biomass as well. And it would be cool for guild...**]**
...
```{r, label = abundance, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Average abundance of the top 6 most abundant species by patch type.", out.width="70%", fig.align='center'}
