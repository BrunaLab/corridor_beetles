...
Dung beetle biomass follows a pattern very similar to abundance where biomass is the highest in matrix plots, followed by connected, then winged, with a large drop in rectangle patches (Figure X). However, variation between individual beetle biomass  
is to large to detect a pattern in statistical analysis (Table X). 
