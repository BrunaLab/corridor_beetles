...
Overall, 5213 total dung beetles were collected belonging to 16 species. Of the most dominant species, the top 6 comprised of 94% of total captures, those being _Canthon vigilans_ (n = 1300) , _Ateuchus lecontei_ (n = 1112), _Phanaeus igneus_ ( n =  958), _Dichotomius carolinus_ (n = 556), _Aphodeus alloblackburneus_ (n = 585), and _Onthophagus pennsylvanicus_ (n = 207) (Table 1). All but four species were found in every patch type. _Onthophagus concinnus_ was found in the matrix and winged patches, while _Onthophagus striatulus_ was found in matrix habitat and rectangular patches. _Geotrupes blackburnii_ and _Onthophagus tuberculifrons_ were the only species restricted to one patch type (winged and matrix, respectively).

When taking into account abundance independent of species ID, patch type was not significantly related to the total beetle counts aside from the rectangle patch where fewer individuals were typically captured. Any further statistical analysis relating to abundance focused on the six most abundant species. 
