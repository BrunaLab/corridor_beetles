...
- functional diversity
  ...
  > 1st pass: roller, tunneler, dweller  
  > after all done: morphological measurements like Alonso et al 2022 (see table from decastro 2023, Giménez Gómez 2025)
...
- abundance (or biomass)
  ...
  > abundance of species caught in all sites?  
  > changes in rank-abundance. 

_Reason for this breakdown: _

- richness and diversity are "community level" response. 
- abundance is a species-level response. 
- changes in abundance or rank-abundance  could have implications for ecosystem services if it is connected to finctional group. 
...
- how many beetles total
- most common species overall
- was. the same species the most common one in all habitats?
- were there any that were caught in all habitats? Any restricted to only one?
- any invasive / exotic species?


Overall, `r total_N` total dung beetles were collected belonging to N = `r total_spp` species. The most dominant species were ______  (N = _____), Ateuchus lecontei (n=1115), and Phanaeus igneus (n=958) (Table 1). All but one species was found in matrix plots. Four species (Onthophagus striatulus, Onthophagus concinnus, Geotrupes Blackburnii, Onthophagus truberculifrons) were the only species not representative in every patch type. We had two singleton species, Geotrupes Blackburnii appearing only once in winged, and Onthophagus tuberculiofrons  in matrix.  
...
![Experimental landscapes indicating location of the pitfall traps.](pitfalls.png)
...
mutate(w=case_when(
  ...
  select(species,Guild,n,m,c,w,r) %>% 
