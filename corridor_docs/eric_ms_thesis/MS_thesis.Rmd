...
When comparing the total abundance of beetles (all species combined) across patch types, there were no significant difference with one exception: fewer individuals were captured in rectangular patches(GLMM, P < 2e-6, Table 4). Statistical analysis of abundance focused on the six most abundant species. When looking at counts for our most abundant species, results were variable but overall follow a consistent pattern where the most individuals of a given species are more frequent in the matrix then corridor and winged patches with a dip at the rectangle patch (Table 6). One difference to note is that _Aphodius alloblackburneus_ had much higher counts in matrix patches in contrast to other patch types (Figure 6). 
...
This study advances our understanding of the factors shaping dung beetle community composition in temperate regions of the southeastern United States. In addition, the experimental design enables direct comparisons between populations in continuous matrix habitat and those in both isolated and corridor connected patches. Our main findings emphasized: (1) Dominant species were most abundant in forested matrix, but not equally for all species, some were represented proportionally higher in matrix than in open patch habitat. (2) Species richness and diversity were relatively consistent across all treatments, however variation across sampling blocks is evident.  
