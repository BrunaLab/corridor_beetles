...
When comparing the total abundance of beetles (all species combined) across patch types, there were no significant difference with one exception: fewer individuals were captured in rectangulat patches. Statistical analysis of abundance relating to abundance focused on the six most abundant species. 
